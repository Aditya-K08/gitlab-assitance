...
export { defaultCustomEvent as CustomEvent, NotSupportCurrentRuntimeClass, consoleLogger, createSHA256, emptyLogger, getEnv, process, setEnvs, uint8ArrayToBase64 };
export type { Logger };
